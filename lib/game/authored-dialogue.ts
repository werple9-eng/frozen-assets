...
export const TUTORIAL_SCRIPT = [
  ...
  'There it is. Once something hits the tray, I can clear it through the system and put your share back in your balance.',
  "You don't need to dig a tunnel under every item. Expose it cleanly and let gravity do the rest.",
